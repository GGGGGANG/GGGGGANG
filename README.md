...
- 코드는 혼자 작성하는 결과물이 아니라, 팀이 함께 읽고 고치는 문서라고 생각합니다.
- 성능 개선은 감이 아니라 동일 시나리오의 before/after 수치로 확인합니다.
- 기술은 사용 경험을 늘리기 위해 고르기보다, 현재 문제와 운영 제약에 맞는지 기준을 세워 선택합니다.
- 협업에서는 기술적 논의만큼 기본적인 의사소통을 중요하게 봅니다. 아침 인사처럼 작은 루틴도 서로의 상태를 확인하고 대화를 시작하는 기준이라고 생각합니다.
- 레거시나 장애 상황에서는 먼저 구조와 흐름을 파악해, 팀이 같은 그림을 보고 판단할 수 있게 만드는 일을 중요하게 봅니다.
